...
<div class="flex items-center ml-1">
    <div><img src="/storage/general/logo.png" class="" alt="{{config('app.company')['name']}}" style="max-height:47px; max-width:100%; background-color:white; padding-right:2px; padding-left:2px;"></div>
